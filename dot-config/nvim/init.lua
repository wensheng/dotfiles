--[[
  ...
  NOTE: THIS IS NOT USED as we are using LunarVim.

Adapted from init.lua in https://github.com/nvim-lua/kickstart.nvim
...
-- Open netrw in 22% split in tree view
vim.api.nvim_set_keymap('n', '<leader>e', ':22Lex<CR>', { noremap = true })
